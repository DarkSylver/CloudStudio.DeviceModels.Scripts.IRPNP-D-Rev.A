...
# Parsing + Configuration Script – IR PNP-D - Rev. A

This **Parsing + Configuration** script is designed for the **IR PNP-D** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – IR PNP-D Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **IR PNP-D** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
